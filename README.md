...
### Examples
This simply adds the Sample ID and hit quality info to the comment field of each record and save the results in another Fasta file. Also shown are the headers for the first three Fasta records with the added information in **bold**.
```bash
